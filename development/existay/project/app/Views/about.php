            ...
            <div class="form-column order-last col-lg-6 col-md-12 col-sm-12">
                <div class="inner-column">
                    <div class="discount-form">
                        <!--Comment Form-->
                        <form method="post" action="<?= url_to("send-email") ?>">
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                    <input type="text"  name="phone" minlength="10" maxlength="15" pattern="[0-9]+" title="please enter number only"   placeholder="Phone" <?= old("phone") ?> required>
                                </div>

                                <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                    <textarea name="message" minlength="50" placeholder="Massage"><?= old("message") ?></textarea>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group text-center">
                                    <?php if (session()->getFlashdata('err')) : ?>
                                        <span class="alert alert-warning"><?= session()->getFlashdata('err') ?></span>
                                    <?php endif; ?>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group text-center">
