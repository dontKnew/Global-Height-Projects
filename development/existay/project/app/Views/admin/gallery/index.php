            ...
            <div class="card mb-4 "> <!--starting card-->
                ...
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    ...
                    <h6 class="d-flex flex-sm-row align-items-center">
                        ...
                        <form action="<?= url_to("admin/gallery") ?>" method="get">
                        ...
                        <div class="d-flex align-items-center px-4">
                            <select class="form-control-sm form-control" name="apartment_title" onchange="this.form.submit()" >
                                ...
                                <?php foreach($apartmentTitle as $value):?>
                                    ...
                                    <?php else:?>
                                        <option value="<?= $value['title'] ?>" selected> <?= ucwords($value['title']) ?></option>
                                    <?php endif; ?>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <h6 class="mb-0">
                                        <img src="<?= base_url("assets/admin/img/gallery/".strtolower($value['image_load'])."/". $value["image"]) ?>" width="150"  class="rounded" height="140" alt="<?= $value["name"] ?>">
                                    </h6>
                                </td>
                                <td>
