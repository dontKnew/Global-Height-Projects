            ...
            <div class="card mb-4 "> <!--starting card-->
                ...
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    ...
                    <h6 class="d-flex flex-sm-row align-items-center">
                        ...
                        <form action="<?= url_to("admin/slider") ?>" method="get">
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <h6 class="mb-0">
                                        <img src="<?= base_url("assets/admin/img/city_slider/".strtolower($value['image_load'])."/". $value["image"]) ?>" width="200"  class="rounded" alt="<?= $value["name"] ?>">
                                    </h6>
                                </td>
                                <td>
