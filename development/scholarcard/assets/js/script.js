...
$('.sub-drop').toggle(1000);
$("i", this).toggleClass("fa-angle-right fa-angle-down");
});

$('.child-list').hide();
$(".child-drop").click(function(){
     $(".child-list", this).toggle(1000);
     $("a i", this).toggleClass("fa-angle-right fa-angle-down");
...
$(window).scroll(function(){
    if ($(this).scrollTop() > 200) {
       $('.man_coumenu').addClass('fixed-top');
    } else {
       $('.man_coumenu').removeClass('fixed-top');
    }
});
