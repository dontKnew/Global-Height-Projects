...
<head>
    <meta charset="utf-8">
    <title> Scholaracad | Admin</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <link href="https://scholaracad.com/assets/img/fv.png" rel="icon">
    ...
    <link rel="stylesheet" href="<?= base_url("css/bootstrap-datetimepickerl.min.css")?>">
</head>
<style>
    * {
    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar  navbar-dark">
            <a href="index.html" class="navbar-brand mx-4 mb-3">
                ...
                <img src="https://scholaracad.com/assets/images/logo.png" alt="scholaracad-logo" width="200" height="50">
            </a>
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="<?= base_url("course-category/add") ?>" class="nav-item nav-link <?php if(isset($addCourseCategory)){echo $addCourseCategory;} ?>"><i class="fa fa-keyboard me-2"></i>Add Course Category</a>
                <a href="<?= base_url("course-category") ?>" class="nav-item nav-link <?php if(isset($courseCategory)){echo $courseCategory;} ?>"><i class="fa fa-keyboard me-2"></i>View Course Category</a>
    ...
    <div class="content">
        ...
        <nav class="navbar navbar-expand  navbar-dark sticky-top px-4 py-3" style="background-color:white;">
            <a href="https://onedunia.com/" class="navbar-brand d-flex d-lg-none me-4">
                <img src="https://scholaracad.com/assets/images/logo.png" alt="schooweblogo" width="200" height="auto">
            </a>
        ...
        <div class="bg-blue rounded-top p-4">
            <div class="row">
                <div class="col-12 col-sm-6 text-center text-sm-start">
                    &copy; <a href="http://scholaracad.com/" style="color:#93c83c;">Scholaracad.Com </a>, All Right Reserved.
                </div>
            </div>
        </div>
    </div>
