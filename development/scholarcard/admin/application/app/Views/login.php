    ...
    <div class="container-fluid">
        <div class="row h-100 justify-content-center" style="min-height: 100vh;">
            <a href="http://onedunia.com/" class=" pt-3" style="box-shadow:1px 0px 9px 0px #dddada;">
                <img src="https://scholaracad.com/assets/images/logo.png" alt="onedunialogo2" width="250" height="auto">
            </a>
            <div class="col-12 col-sm-8 col-md-6 col-lg-8 col-xl-6">
                <div class="bg-blue rounded p-4 p-sm-5 my-4 mx-3">
                    <div class="text-center my-4">
                        <h3><span class="text-danger text-sm">(Restricated Area)</span> <br><br><i class="fa fa-user-secret" aria-hidden="true"></i>
                             Admin Login <i class="fa fa-user-secret" aria-hidden="true"></i>
                        </h3>
                    </div>
