    ...
    <div class="sidebar">
        <div class="scrollbar-inner sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li class="nav-item <?php if(isset($dealership) ){ echo $dealership;} ?>">
                    <a href="<?= base_url("admin/category") ?>">
                        <i class="la la-table"></i>
                        <p>Category</p>
                        <span class="badge badge-info"><?php if(isset($dealership)): echo esc($dealership); endif; ?></span>
                    </a>
                </li>
