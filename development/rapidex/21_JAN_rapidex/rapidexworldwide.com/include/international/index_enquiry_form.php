...
<div class="contact-form">
    <h4 class="text-left" style="color: #150ba5 !important;margin-top:5px; font-size:28px;">Calculate Shipping Charges</h4>
    <p class="text-left" style="font-size:16px;">Fill the details from below list to get the best price</p>
    <form action="../shipping-charges.php" class="wpcf7-form" method="post" style="color: #150ba5 !important; margin-top:20px; font-size:16px;"> 
        <div class="row gy-1">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label style="color:#150ba5 !important">Dimensions in Cm</label>
            ...
            <div class="col-lg-12 col-md-12 text-center">
                <button type="submit" value="Submit" name="submit" class="default-btn-one" style="background: #ce2827; color:#fff; position:relative;top:10px;" data-loading-text="Please wait...">Get Charges </button>
            </div>
