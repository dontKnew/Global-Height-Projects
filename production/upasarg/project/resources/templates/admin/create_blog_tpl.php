    ...
    <div class="layout-px-spacing">
        <div class="row layout-top-spacing" id="cancel-row">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <h4><?php if(isset($_GET['blog_id'])) {echo 'Update';} else {echo 'Create';} ?> Blog<?php if(isset($_GET['blog_id'])) {echo " - {$db_detail['title']}";}?></h4>
                    ...
                    <div class="table-responsive mb-4 mt-4">
                        ...
                        <form method="POST" name="frm-login" class="account-form" data-parsley-validate="">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" placeholder="Enter Blog Title" id="title" value="<?=old('title')?>" required>
                                <?=error('title')?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="content-editor" class="form-control" name="content" placeholder="Enter Blog content" required><?=old('content')?></textarea>
                                <?=error('content')?>
                            </div>
                            <div class="form-group text-center">
                                <button type="submit" name="submit" class="btn btn-success mt-2 mb-2">
                                    <?php if(isset($_GET['blog_id'])) {echo 'Update';} else {echo 'Create';} ?>
                                </button>
                                <a href="<?=$routes['admin_list_blog']?>">
