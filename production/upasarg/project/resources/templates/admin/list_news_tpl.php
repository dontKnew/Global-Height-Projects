        ...
        <div class="row layout-top-spacing" id="cancel-row">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <a href="<?=$routes['admin_create_news']?>"><button class="btn btn-success">Create New</button></a>
                    </div>
                </div>
                                ...
                                <tr sort="<?=$v['id']?>" style="<?=$style?>">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink-<?=$k?>">
                                            ...
                                            ?>
                                            <a class="dropdown-item" href="<?=$routes['admin_list_news']?>?id=<?=$v['id']?>&status=<?=$s?>" onclick="return confirm('Are you sure to change the status?')">
                                                <?=ucwords($s)?>
                                            </a>
                                            <?php } ?>
                                        </div>
                                    ...
                                    <td><?=$v['date_modify']?></td>
                                    <td>
                                        <a title="edit" class="dropdown-item" href="<?=$routes['admin_create_news']?>?id=<?=$v['id']?>">
                                        ...
                                        <a title="delete" class="dropdown-item" href="<?=$routes['admin_create_news']?>?id=<?=$v['id']?>&action=delete" onclick="return confirm('Are you sure to proceed?')">
